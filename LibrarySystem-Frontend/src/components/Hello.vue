...
<template>
  <div class="hello">
    ...
    <ul>
      <li>
        <button style="margin-bottom: 25px;" class="btn btn-light" v-on:click="goLogin()">Login</button>
      </li>
      <li>
        <button style="margin-bottom: 25px;" class="btn btn-light" v-on:click="goSignUp()">Signup</button>
      </li>
    </ul>

    <h3 style="text-align: center">Library Opening Hours</h3>
...
export default {
  ...
  data() {
    return {
      msg: "Welcome to Your Local Library",
      email: "Email: group23@mail.mcgill.ca",
